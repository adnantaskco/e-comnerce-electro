  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 md:px-8 lg:px-16 py-6 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        {/* LEFT SIDE */}
        <div className="w-full lg:flex-1 bg-white rounded-2xl border shadow-sm">
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <div className="hidden md:grid grid-cols-12 text-sm font-semibold text-gray-500 border-b px-5 py-3">
              ...
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="grid grid-cols-12 items-center px-5 py-5 border-b hover:bg-gray-50 transition"
                >
                  ...
                  {/* TOTAL */}
                  <div className="col-span-6 md:col-span-2 text-right font-semibold mt-3 md:mt-0">
          ...
          <div className="bg-white border rounded-2xl shadow-md p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <button
                ...
                className="w-full mt-4 bg-black text-white py-3 rounded-xl font-medium hover:bg-gray-900 disabled:opacity-40 transition"
              >
                Proceed to Checkout
              </button>
            </div>
